...
namespace Test.Items.Weapons
{
	public class CursedBlade : ModItem
	{
		...
		{
			item.name = "Cursed Blade";		//The name of your weapon
			item.damage = 45;			//The damage of your weapon
			item.melee = true;			//Is your weapon a melee weapon?
			item.width = 40;			//Weapon's texture's width
			item.height = 40;			//Weapon's texture's height
			item.toolTip = "Made from the parts of The Twins.";
			item.toolTip2 = "Has a chance to inflict the Cursed Inferno debuff.";
